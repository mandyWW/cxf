...
public class LocalJndiConduit extends AbstractConduit {

    private final class LocalConduitOutputStream extends AbstractWrappedOutputStream {
        private final LocalJndiConduit conduit;
        private final Exchange exchange;
        private final Message message;

        private LocalConduitOutputStream(LocalJndiConduit conduit, Exchange exchange, Message message) {
    ...
    public static final String IN_CONDUIT = LocalJndiConduit.class.getName() + ".inConduit";
    public static final String RESPONSE_CONDUIT = LocalJndiConduit.class.getName() + ".inConduit";
    public static final String IN_EXCHANGE = LocalJndiConduit.class.getName() + ".inExchange";
    public static final String DIRECT_DISPATCH = LocalJndiConduit.class.getName() + ".directDispatch";
    public static final String MESSAGE_FILTER_PROPERTIES = LocalJndiTransportFactory.MESSAGE_FILTER_PROPERTIES;

    private static final Logger LOG = LogUtils.getL7dLogger(LocalJndiConduit.class);
    
    private LocalJndiDestination destination;
    private LocalJndiTransportFactory transportFactory;

    public LocalJndiConduit(LocalJndiTransportFactory transportFactory, LocalJndiDestination destination) {
    ...
    private void dispatchDirect(Message message) throws IOException {
        ...
        ex.put(LocalJndiConduit.DIRECT_DISPATCH, true);
    ...
    private void dispatchViaPipe(final Message message) throws IOException {
        final LocalJndiConduit conduit = this;
